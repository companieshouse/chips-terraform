...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudwatch-alarms"></a> [cloudwatch-alarms](#module\_cloudwatch-alarms) | git@github.com:companieshouse/terraform-modules//aws/ec2-cloudwatch-alarms | tags/1.0.123 |
...
| <a name="module_oracledb_cloudwatch_alarms"></a> [oracledb\_cloudwatch\_alarms](#module\_oracledb\_cloudwatch\_alarms) | git@github.com:companieshouse/terraform-modules//aws/oracledb_cloudwatch_alarms | tags/1.0.173 |
...
| [vault_generic_secret.chs_subnets](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/data-sources/generic_secret) | data source |
...
| <a name="input_chips_staff_oem_sg"></a> [chips\_staff\_oem\_sg](#input\_chips\_staff\_oem\_sg) | OEM Security Group | `string` | `""` | no |
...
| <a name="input_staffware_db_sg"></a> [staffware\_db\_sg](#input\_staffware\_db\_sg) | List of Staffware DB Security Groups | `list(any)` | `[]` | no |
