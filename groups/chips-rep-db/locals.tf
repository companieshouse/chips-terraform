...
locals {
  ...
  oracle_allowed_ranges = concat(var.vpc_sg_cidr_blocks_oracle, local.additional_app_cidrs, local.dblink_cidrs, local.additional_internal_cidrs )
  ssh_allowed_ranges    = concat(var.vpc_sg_cidr_blocks_ssh, local.deployment_cidrs, local.additional_internal_cidrs)
