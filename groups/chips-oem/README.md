...
| [aws_instance.oem_ec2](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance) | resource |
| [aws_key_pair.ec2_keypair](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/key_pair) | resource |
| [aws_route53_record.oem_dns](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
| [aws_sns_topic.chips-oem_topic](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic) | resource |
| [aws_sns_topic_subscription.chips-oem_Subscription](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic_subscription) | resource |
| [aws_sns_topic_subscription.chips-oem_Subscriptionhttps](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic_subscription) | resource |
...
| [vault_generic_secret.e5_oem](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/data-sources/generic_secret) | data source |
...
| <a name="input_chips_oem_sg"></a> [chips\_oem\_sg](#input\_chips\_oem\_sg) | List of CHIPS OEM Security Groups | `list(any)` | `[]` | no |
...
| <a name="input_vpc_sg_cidr_blocks_oem"></a> [vpc\_sg\_cidr\_blocks\_oem](#input\_vpc\_sg\_cidr\_blocks\_oem) | Security group cidr blocks for OEM | `list(any)` | `[]` | no |
